...
from pinax.account.forms import (
    ChangePasswordForm,
    LoginUsernameForm,
    PasswordResetForm,
...
from pinax.account.mixins import LoginRequiredMixin
...
from pinax.account.utils import default_redirect, get_form_data
...
class SignupView(PasswordMixin, FormView):
    ...
    template_name = "pinax.account/signup.html"
    template_name_ajax = "pinax.account/ajax/signup.html"
    template_name_email_confirmation_sent = "pinax.account/email_confirmation_sent.html"
    template_name_email_confirmation_sent_ajax = "pinax.account/ajax/email_confirmation_sent.html"
    template_name_signup_closed = "pinax.account/signup_closed.html"
    template_name_signup_closed_ajax = "pinax.account/ajax/signup_closed.html"
...
class LoginView(FormView):
    ...
    template_name = "pinax.account/login.html"
    template_name_ajax = "pinax.account/ajax/login.html"
...
class LogoutView(TemplateResponseMixin, View):
    ...
    template_name = "pinax.account/logout.html"
    redirect_field_name = "next"
...
class ConfirmEmailView(TemplateResponseMixin, View):
    ...
    def get_template_names(self):
        return {
            "GET": ["pinax.account/email_confirm.html"],
            "POST": ["pinax.account/email_confirmed.html"],
        }[self.request.method]
...
class ChangePasswordView(PasswordMixin, FormView):
    ...
    template_name = "pinax.account/password_change.html"
...
class PasswordResetView(FormView):
    ...
    template_name = "pinax.account/password_reset.html"
    template_name_sent = "pinax.account/password_reset_sent.html"
...
class PasswordResetTokenView(PasswordMixin, FormView):
    ...
    template_name = "pinax.account/password_reset_token.html"
    template_name_fail = "pinax.account/password_reset_token_fail.html"
...
class SettingsView(LoginRequiredMixin, FormView):
    ...
    template_name = "pinax.account/settings.html"
...
class DeleteView(LoginRequiredMixin, LogoutView):
    ...
    template_name = "pinax.account/delete.html"
    messages = {
        "account_deleted": {
            "level": messages.WARNING,
